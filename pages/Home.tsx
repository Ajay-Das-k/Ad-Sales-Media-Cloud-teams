...
import {
    USPS, EXTENDS_SF, KPIS, FAQS, LOGOS
} from '../constants';
import {
    Section, Card, CTAButton, IconTile, KPIGrid, FAQAccordion
} from '../components/UI';
...
const Home: React.FC<HomeProps> = ({ onBookDemo, onWatchVideo }) => {
    useEffect(() => {
            ...
            <Section id="problem" className="py-24 reveal">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-6xl mx-auto px-4">
                    ...
                    <Card className="p-8 md:p-10 border-t-4 border-t-red-500 bg-white dark:bg-slate-800 shadow-xl reveal h-full flex flex-col">
                        ...
                        <div className="flex-1 flex flex-col justify-center mb-8 min-h-[200px] items-center">
                            <img
                                src="/problem_illustration_light.png"
                                alt="Disconnected Systems"
                                className="w-full max-w-[280px] h-auto object-contain block dark:hidden animate-float drop-shadow-lg"
                            />
                            <img
                                src="/problem_illustration_dark.png"
                                alt="Disconnected Systems"
                                className="w-full max-w-[280px] h-auto object-contain hidden dark:block animate-float drop-shadow-green-900/50"
                            />
                        </div>
                    ...
                    <Card className="p-8 md:p-10 border-t-4 border-t-green-500 bg-white dark:bg-slate-800 shadow-xl reveal h-full flex flex-col">
                        ...
                        <div className="flex-1 flex items-center justify-center mb-8 relative min-h-[200px]">
                            <img
                                src="/solution_illustration_light.png"
                                alt="Connected System"
                                className="w-full max-w-[320px] h-auto object-contain block dark:hidden animate-pulse-slow drop-shadow-xl"
                            />
                            <img
                                src="/solution_illustration_dark.png"
                                alt="Connected System"
                                className="w-full max-w-[320px] h-auto object-contain hidden dark:block animate-pulse-slow drop-shadow-blue-500/30"
                            />
                        </div>
            ...
            <div className="relative py-32 mt-24 mx-4 rounded-3xl overflow-hidden bg-slate-900 border border-white/10 shadow-2xl reveal">
                ...
                <div className="relative z-10 max-w-4xl mx-auto text-center px-4">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
                        <CTAButton onClick={onBookDemo} className="w-full sm:w-auto bg-primary hover:bg-primary-dark text-white border-0 h-16 px-12 text-xl font-bold shadow-xl shadow-primary/25 hover:shadow-primary/40 hover:-translate-y-1 transition-all duration-300">
                            Request a Demo
                        </CTAButton>

                        <button onClick={onBookDemo} className="group flex items-center gap-3 text-slate-300 font-bold text-lg hover:text-white transition-colors px-6 py-4 rounded-xl hover:bg-white/5">
