...
import { 
  Section, Card, CTAButton, IconTile, KPIGrid, FAQAccordion, ArchitectureDiagram 
} from './components/UI';

const App: React.FC = () => {
  // Updated initialization to default to false (white theme) unless previously set to 'dark'
  ...
  return (
    <div className="min-h-screen font-sans bg-background-light dark:bg-background-dark text-slate-900 dark:text-slate-100 transition-colors duration-300">
      ...
      {/* Hero Section */}
      <Section id="hero" className="pt-16 pb-24 overflow-hidden">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            ...
            <div className="relative bg-slate-900 rounded-xl overflow-hidden shadow-2xl aspect-video border border-white/10 flex items-center justify-center">
              <div className="absolute inset-0 bg-gradient-to-br from-primary/20 to-transparent pointer-events-none"></div>
              <span className="material-symbols-outlined text-white/20 text-8xl">play_circle</span>
      ...
      {/* Problem & Solution */}
      <Section id="problem" className="bg-slate-50 dark:bg-slate-900/50 py-24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <Card className="p-8 border-red-500/20 dark:border-red-500/10 bg-white dark:bg-slate-800">
            ...
            {/* Diagram Placeholder */}
            <div className="h-48 rounded-lg bg-slate-100 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 mb-8 relative flex items-center justify-center">
              <div className="grid grid-cols-3 gap-8">
                <div className="p-2 border border-dashed border-red-500/50 rounded rotate-[-12deg]"><span className="material-symbols-outlined text-slate-400">table_view</span></div>
                <div className="p-2 border border-dashed border-red-500/50 rounded rotate-[15deg]"><span className="material-symbols-outlined text-slate-400">mail</span></div>
                <div className="p-2 border border-dashed border-red-500/50 rounded rotate-[-5deg]"><span className="material-symbols-outlined text-slate-400">payments</span></div>
              </div>
            ...
            <ul className="space-y-3">
              {['CRM', 'Proposal app', 'OMS', 'PM', 'Billing/Finance', 'Spreadsheets'].map(item => (
          ...
          <Card className="p-8 border-primary/20 bg-primary/5 dark:bg-primary/10">
            <div className="flex items-center gap-2 mb-6">
            ...
            {/* Solution Diagram */}
            <div className="h-48 rounded-lg bg-white dark:bg-slate-800 border border-primary/20 mb-8 relative flex items-center justify-center">
              <div className="relative">
                <div className="w-16 h-16 rounded-full bg-primary flex items-center justify-center text-white z-10 relative">
                  <span className="material-symbols-outlined">hub</span>
                </div>
                {/* Flow lines (CSS only) */}
                <div className="absolute inset-[-40px] border border-primary/20 rounded-full animate-ping opacity-20"></div>
                <div className="absolute top-1/2 left-[-100px] right-[-100px] h-[1px] bg-gradient-to-r from-transparent via-primary/50 to-transparent"></div>
              </div>
            </div>
      ...
      {/* USP Section */}
      <Section id="usp" className="py-24">
        <div className="text-center mb-16">
        ...
        <div className="flex flex-col gap-6 max-w-4xl mx-auto">
          {USPS.map((usp, i) => (
            <Card key={i} className={`p-8 flex items-start gap-8 hover:border-primary/50 transition-all bg-white dark:bg-slate-900/50 ${i % 2 === 1 ? 'bg-slate-50 dark:bg-slate-900/80' : ''}`}>
      ...
      {/* Audience Split */}
      <Section id="audience" className="bg-background-dark text-white py-24 rounded-3xl mx-4 mb-24 overflow-hidden relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
          <Card className="p-10 bg-white/5 border-white/10 flex flex-col items-center text-center backdrop-blur-sm">
      ...
      {/* Extends Salesforce */}
      <Section id="extends-sf" className="py-24">
        <div className="text-center mb-16">
        ...
        <div className="p-6 rounded-2xl bg-primary text-white text-center font-bold text-lg shadow-xl shadow-primary/20">
          Outcome: A unified revenue engine that actually speaks "Media" out of the box.
        </div>
      </Section>

      {/* AI Workflows */}
      <Section id="workflows" className="bg-slate-50 dark:bg-slate-900/50 py-24">
        <div className="text-center mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
          {WORKFLOWS.slice(0, 3).map((item, i) => (
            <Card key={i} className="p-6 hover:shadow-lg transition-shadow bg-white dark:bg-slate-800">
        ...
        <Card className="p-8 bg-gradient-to-r from-background-dark to-slate-800 text-white border-none flex flex-col md:flex-row items-center gap-6">
          <div className="w-20 h-20 shrink-0 rounded-full bg-primary flex items-center justify-center shadow-lg shadow-primary/40 animate-pulse">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          <div className="flex-1 space-y-8">
            <div className="p-4 border-l-4 border-primary bg-primary/5">
              <h4 className="font-bold text-lg mb-2">Core: PacePal</h4>
              <p className="text-sm text-slate-600 dark:text-slate-400">The reasoning engine that connects user intent with automated system actions.</p>
            </div>
            <div className="p-4 border-l-4 border-slate-300 dark:border-slate-700">
              <h4 className="font-bold text-lg mb-2">Ring 2: Task Agents</h4>
              <p className="text-sm text-slate-600 dark:text-slate-400">Scout, Planner, Optimizer, and Auditor — each specialized for the ad sales lifecycle.</p>
            </div>
            <div className="p-4 border-l-4 border-slate-300 dark:border-slate-700">
              <h4 className="font-bold text-lg mb-2">Ring 3: MCPs</h4>
              <p className="text-sm text-slate-600 dark:text-slate-400">Standardized connectors for media planning, inventory, and pricing protocols.</p>
            </div>
          </div>
        </div>
      </Section>
      ...
      {/* Converged Ad Sales */}
      <Section id="channels" className="py-24 bg-background-dark text-white rounded-t-3xl mx-4">
        <div className="text-center mb-16">
        ...
        <div className="flex flex-col items-center gap-12">
          <div className="relative w-72 h-72 flex items-center justify-center">
             <div className="w-24 h-24 rounded-full bg-primary flex items-center justify-center text-white z-10 shadow-2xl shadow-primary/40">
      ...
      <Section id="proof" className="py-24">
        ...
        <div className="mt-16 flex flex-wrap justify-center gap-12 grayscale opacity-40">
           {['ADA', 'SONY', 'YAHOO!', 'PARAMOUNT', 'DISNEY', 'WARNER'].map(brand => (
      ...
      <Section className="py-24 bg-gradient-to-r from-primary to-secondary text-white text-center">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          <CTAButton className="bg-white text-primary hover:bg-slate-100 h-14 px-10 text-lg">Request a Demo</CTAButton>
          <CTAButton className="bg-transparent border-white text-white hover:bg-white/10 h-14 px-10 text-lg">Talk to an Expert</CTAButton>
        </div>
      ...
      {/* Footer */}
      <footer className="py-12 border-t border-slate-200 dark:border-slate-800 bg-white dark:bg-background-dark">
